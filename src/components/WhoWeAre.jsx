...
const WhoWeAre = () => {
    return (
        <div className="mb-10 md:mb-20 lg:mb-40 flex flex-col md:flex-row px-8 lg:px-0">
            <div className="md:w-1/2 md:pr-8">
                ...
                <button className="btn bg-[#FFC637] rounded-xl hover:bg-[#e7b330] hover:text-white font-medium">Learn more <MdArrowOutward /></button>
            </div>
            <div className="md:w-1/2 md:ml-8 mt-8 md:mt-0">
                <img className="w-full" src="/Media/Rectangle 24.png" alt="" />
                <div className="relative w-4/5 md:max-w-[360px] h-52 rounded-3xl -mt-20 md:-mt-[165px] md:-ml-16 bg-[#343268] ">
